  ...
  return (
    <div className="w-full min-w-0">
      ...
      <div className="mb-5 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <h1 className="flex items-center gap-2 text-2xl font-bold tracking-tight text-primary-900">
            <FileSignature className="hidden h-7 w-7 text-primary-600 sm:block" />
            Contracts
          </h1>
          <p className="mt-2 text-sm text-neutral-600">
            Manage both employee contracts and consultant doctor contracts with renewal reminders.
          </p>
        </div>
        <button
          type="button"
      ...
      {openCreate ? (
        <form onSubmit={handleCreate} className="mb-4 rounded-xl border border-neutral-200 bg-white p-4">
      ...
      <div className="mb-3 flex items-center gap-2 rounded-xl border border-neutral-200 bg-white p-3">
