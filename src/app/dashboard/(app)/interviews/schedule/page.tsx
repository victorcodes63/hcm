    ...
    <div className="w-full min-w-0">
      ...
      <div className="mb-6 sm:mb-8 w-full min-w-0">
        ...
        <p className="text-neutral-600 text-sm sm:text-base w-full">
          Bulk schedule up to 10 interviews from a shortlisted job. Add optional breaks (lunch, buffers) on the same day—they
          are saved together with the interviews. Times are auto-spaced for candidates; breaks use the times you set.
        </p>
      </div>
      ...
      <div className="space-y-6 sm:space-y-8">
        ...
        <div className="bg-white rounded-xl border border-neutral-200 shadow-sm p-5 sm:p-6 lg:p-8">
          ...
          >
            {/* Schedule + breaks */}
            <div className="min-w-0 space-y-3 rounded-lg border border-neutral-200/80 bg-white p-4 lg:border-0 lg:bg-transparent lg:p-0">
            ...
            {/* Candidates */}
            <div className="min-w-0 mt-6 lg:mt-0 rounded-lg border border-neutral-200/80 bg-white p-4 lg:border-0 lg:bg-transparent lg:p-0">
