  ...
  return (
    <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
      <div className="rounded-xl border border-neutral-200 bg-white p-4 lg:col-span-2">
        ...
        <h1 className="mt-2 text-xl font-semibold text-primary-900">
          {data.caseNumber} — {data.subject}
        </h1>
        <p className="mt-1 text-sm text-neutral-600">
          {data.employee.firstName} {data.employee.lastName} | {data.type.replaceAll('_', ' ')} | {data.severity.replaceAll('_', ' ')}
        </p>
