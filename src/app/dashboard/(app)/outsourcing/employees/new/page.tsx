  ...
  return (
    <div className="w-full min-w-0">
      ...
      <div className="mb-6 flex items-start gap-3">
        ...
        <div>
          <h1 className="flex items-center gap-2 text-xl font-bold text-neutral-900 sm:text-2xl">
            <UserPlus className="h-7 w-7 shrink-0 text-primary-600" />
            Add employee
          </h1>
          <p className="mt-1 text-sm text-neutral-600">Add one person below, or import many at once with Excel.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-6 rounded-2xl border border-neutral-200 bg-white p-5 shadow-sm sm:p-6 lg:p-8">
