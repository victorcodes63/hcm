...
export default function DashboardJobsPage() {
  ...
  return (
    <div className="w-full min-w-0">
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-8">
        <div className="min-w-0">
          ...
          <p className="text-neutral-600 text-sm sm:text-[15px] leading-relaxed max-w-xl">
            Manage postings and publish roles to your careers page.
          </p>
        </div>
        <Link
      ...
      {!loading && jobs.length > 0 && (
        <>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
            <div className="relative overflow-hidden rounded-2xl border border-neutral-200/90 bg-white p-5 shadow-sm">
          ...
          <div className="rounded-2xl border border-neutral-200/90 bg-white p-4 sm:p-5 shadow-sm mb-6">
      ...
      {loading ? (
        <div className="rounded-2xl border border-neutral-200 bg-white p-10 sm:p-14">
        ...
        <div className="rounded-2xl border border-neutral-200 bg-white p-10 sm:p-12 text-center shadow-sm">
            ...
            <table className="w-full min-w-[720px] text-sm">
              <thead>
                <tr className="bg-neutral-50/95 border-b border-neutral-200">
                  <th className="text-left text-[11px] font-bold uppercase tracking-widest text-neutral-500 px-4 sm:px-5 py-3.5 w-[7rem]">
                    Job ID
                  </th>
                  <th className="text-left text-[11px] font-bold uppercase tracking-widest text-neutral-500 px-4 sm:px-5 py-3.5 min-w-[12rem]">
                    Role
                  </th>
                  ...
                  <th className="text-center text-[11px] font-bold uppercase tracking-widest text-neutral-500 px-3 py-3.5 w-[5rem]">
                    Apps
                  </th>
                  <th className="text-left text-[11px] font-bold uppercase tracking-widest text-neutral-500 px-4 sm:px-5 py-3.5 w-[8.5rem]">
                    Status
                  </th>
                  <th className="text-right text-[11px] font-bold uppercase tracking-widest text-neutral-500 px-4 sm:px-5 py-3.5 w-[7.5rem]">
                    Actions
                  </th>
                </tr>
              </thead>
                ...
                {filteredJobs.map((job, index) => (
                  <tr
                    ...
                    className={`transition-colors group ${
                      index % 2 === 0
                        ? 'bg-white hover:bg-primary-50/95'
                  ...
                  >
                    ...
                    <td className="px-3 py-3.5 text-center tabular-nums font-medium text-neutral-700 align-middle">
